...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        customeYellow: '#C9A44A',
        customeWhite: '#F5F5F5',
        customeWhite1: '#D9D9D9',
        customeBlack1: '#0B0B0C',
        customeBlack2: '#121214',
        customeBlack3: '#1A1A1A',
        customeBlack4: '#0F0F0F',
        customeBlack5: '#19191C',
        customeGray1: '#8A8A8E',
        customeGray2: '#1C1C1C',
        customeGray3: '#1B1B1B',
        customeGray4: '#131210',
        customeGray5: '#242428',
        customeRed: '#EB5757',
        customeLightBlack: '#33333380',
        customeLightBlack1: '#21201F',
        customeBorder: '#29292E',
        customeGreen: '#00B69B',
      },
      fontFamily: {
        'cinzel': ['Cinzel', 'serif'],
      ...
      fontSize: {
        ...
        '70': ['70px', { lineHeight: '74px' }],
        '72': ['72px', { lineHeight: '76px' }],
        '78': ['78px', { lineHeight: '82px' }],
        '96': ['96px', { lineHeight: '100px' }],
        '128': ['128px', { lineHeight: '132px' }],
      }
    },
  },
  plugins: [],
